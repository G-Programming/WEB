========================================================================
     Microsoft Foundation Class Library for Windows CE: DrawExam
========================================================================


AppWizard has created this DrawExam application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your DrawExam application.

DrawExam.h
    This is the main header file for the application.  It includes other
    project specific headers (including Resource.h) and declares the
    CDrawExamApp application class.
...
res\DrawExam.ico
    ...
    icon is included by the main resource file DrawExam.rc.
...
DrawExamDoc.h, DrawExamDoc.cpp - the document
    These files contain your CDrawExamDoc class.  Edit these files to
    add your special document data and to implement file saving and loading
    (via CDrawExamDoc::Serialize).

DrawExamView.h, DrawExamView.cpp - the view of the document
    These files contain your CDrawExamView class.
    CDrawExamView objects are used to view CDrawExamDoc objects.
...
StdAfx.h, StdAfx.cpp
    ...
    named DrawExam.pch and a precompiled types file named StdAfx.obj.
